...
// Returns the private 'App\Repository\FinansbankRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/FinansbankRepository.php';

return $this->privates['App\\Repository\\FinansbankRepository'] = new \App\Repository\FinansbankRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));

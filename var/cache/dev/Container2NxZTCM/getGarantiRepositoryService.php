...
// Returns the private 'App\Repository\GarantiRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/GarantiRepository.php';

return $this->privates['App\\Repository\\GarantiRepository'] = new \App\Repository\GarantiRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
